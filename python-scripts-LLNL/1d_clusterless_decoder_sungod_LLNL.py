...
print('rips when animal velocity <= 4: '+str(linflat_ripindex_encode_velthresh.shape[0]), file=open("/p/lustre1/coulter5/remy/1d_decoder_log.txt","a"))
...
print('original length: '+str(spk_subset.shape[0]), file=open("/p/lustre1/coulter5/remy/1d_decoder_log.txt","a"))
print('after filtering: '+str(spk_subset_sparse.shape[0]), file=open("/p/lustre1/coulter5/remy/1d_decoder_log.txt","a"))
...
print('encoding spikes after filtering: '+str(spk_subset_sparse_encode.shape[0]), file=open("/p/lustre1/coulter5/remy/1d_decoder_log.txt","a"))
...
print('original length: '+str(spk_subset_decode.shape[0]), file=open("/p/lustre1/coulter5/remy/1d_decoder_log.txt","a"))
print('after filtering: '+str(spk_subset_sparse_decode.shape[0]), file=open("/p/lustre1/coulter5/remy/1d_decoder_log.txt","a"))
...
print('decoding spikes after filtering: '+str(spk_subset_sparse_decode_filt.shape[0]), file=open("/p/lustre1/coulter5/remy/1d_decoder_log.txt","a"))
...
if os.path.exists(linearization_output1_save_filename) == False:
    ...
    print("Linearization result doesnt exist. Doing linearization calculation.", file=open("/p/lustre1/coulter5/remy/1d_decoder_log.txt","a"))
    ...
    print('saving file:',file_name_temp, file=open("/p/lustre1/coulter5/remy/1d_decoder_log.txt","a"))
...
#filter linearized position for velocity > 4 cm/s
...
print('Encoder started at: ',datetime.fromtimestamp(os.path.getmtime('/home/mcoulter/spykshrk_realtime/time_stamp1.csv')).strftime('%Y-%m-%d %H:%M:%S'), file=open("/p/lustre1/coulter5/remy/1d_decoder_log.txt","a"))
print('Encoder finished at: ',datetime.fromtimestamp(os.path.getmtime('/home/mcoulter/spykshrk_realtime/time_stamp2.csv')).strftime('%Y-%m-%d %H:%M:%S'), file=open("/p/lustre1/coulter5/remy/1d_decoder_log.txt","a"))
...
print("Starting decoder", file=open("/p/lustre1/coulter5/remy/1d_decoder_log.txt","a"))
...
print('Decoder finished!', file=open("/p/lustre1/coulter5/remy/1d_decoder_log.txt","a"))
...
print('Saved posteriors to /vortex/mcoulter/posteriors/remy_20_2_whole_testing_4_2_19.nc', file=open("/p/lustre1/coulter5/remy/1d_decoder_log.txt","a"))
...
print('Saved linearized position to /vortex/mcoulter/linearized_position/remy_20_2_whole_testing_4_2_19.nc', file=open("/p/lustre1/coulter5/remy/1d_decoder_log.txt","a"))
