...
for encode, decode in kf.split(starttimes):
    ...
    encode_trial_marks_all_sparse = trodes2SS.threshold_marks(encode_trial_marks_all, maxthresh=2000,minthresh=100)
    decode_trial_marks_all_sparse = trodes2SS.threshold_marks(decode_trial_marks_all, maxthresh=2000,minthresh=100)
    ...
    post_netcdf_filename = '/data2/mcoulter/posteriors/remy_20_2_crossval_new_2_' + str(crossval_counter) + '_mark_stdev_20_posterior.nc'
    ...
    position_netcdf_filename = '/data2/mcoulter/linearized_position/remy_20_2_crossval_new_2_' + str(crossval_counter) + '_mark_stdev_20_linear_position.nc'
