...
#        return self.results
    ...
    def setup_encoder_dask(self):
        ...
        for dec_tet_id, dec_spk_tet in dec_grp:
            ...
            #pos_for_csv = enc_tet_lin_pos.reset_index()
            #pos_for_csv.to_csv('/mnt/vortex/mcoulter/pos_random_sort.csv')
    ...
    def _calc_occupancy(lin_obj: FlatLinearPosition, enc_settings: EncodeSettings):
        ...
        occupancy += 1e-10
        print('convolution occupancy normalization test')         
        return occupancy
...
class OfflinePPDecoder(object):
    ...
    def run_decoder(self):
        ...
        # actually, only need to set column x000 to NaN and then will search for NaN with 'any' below
